...
and managing multi-database scenarios for memoria instances.
"""
...
class DatabaseConnectionUtils:
    ...
    def parse_connection_string(cls, connection_string: str) -> dict[str, str]:
        ...
        Example:
            mysql://root:pass@localhost:3306/memoria_dev
            -> {
                'engine': 'mysql',
                'user': 'root',
                'password': 'pass',
    ...
    def generate_database_name(
        cls, base_name: str = "memoria", suffix: str = None, prefix: str = None
    ) -> str:
        """
        ...
        Examples:
            generate_database_name() -> "memoria"
            generate_database_name(suffix="dev") -> "memoria_dev"
            generate_database_name(prefix="acme", suffix="prod") -> "acme_memoria_prod"
        """
        parts = []
