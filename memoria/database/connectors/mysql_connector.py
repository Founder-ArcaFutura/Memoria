"""
MySQL connector for the Memoria 0.9 alpha (0.9.0a0) release.
...
class MySQLConnector(BaseDatabaseConnector):
    ...
    def _parse_connection_string(self, connection_string: str) -> dict[str, Any]:
        ...
        if isinstance(connection_string, str):
            ...
            if separator and scheme.lower().startswith("mysql"):
                base_scheme = scheme.split("+", 1)[0]
                normalized_connection_string = f"{base_scheme}{separator}{remainder}"
                parsed = urlparse(normalized_connection_string)
                return {
