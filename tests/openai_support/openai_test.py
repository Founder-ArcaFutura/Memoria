...
from tests.utils.test_utils import get_test_model, load_inputs  # noqa: E402
...
def validate_openai_config():
    ...
    config = {
        ...
        "model": os.getenv("OPENAI_MODEL", get_test_model()),
...
def run_openai_test_scenario(
    ...
    # Initialize Memoria with specific configuration
    memory = Memoria(
