...
class DummyMemoria:
    ...
    def retrieve_memories_near(self, x, y, z, max_distance, anchor=None, limit=10):
    ...
    def retrieve_memories_near_2d(self, y, z, max_distance, anchor=None, limit=10):
...
def _setup_client(monkeypatch):
    dummy = DummyMemoria()
    monkeypatch.setattr("memoria.Memoria", lambda *args, **kwargs: dummy)
