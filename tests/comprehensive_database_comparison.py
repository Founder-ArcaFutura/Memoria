...
Tests SQLite, MySQL, and PostgreSQL with Memoria across all functionality
"""
...
def get_database_connections():
    ...
    try:
        ...
        connections["PostgreSQL"] = (
            f"postgresql+psycopg2://{user}{password_part}@{host}:{port}/memoria_test"
        )
    except:
        pass
...
def main():
    ...
    print("Testing SQLite, MySQL, and PostgreSQL with Memoria")
    print("=" * 70)
