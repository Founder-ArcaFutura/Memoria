"""
Memoria PostgreSQL Demo

Configure your preferred model by editing ``agents.default_model`` in
``memoria.json``.
"""
...
print("Initializing Memoria with PostgreSQL database...")
litellm_memory = Memoria(
    database_connect="postgresql+psycopg2://postgres:@localhost:5432/memoria_db",
...
print("Memoria PostgreSQL Demo - Chat with GPT-4o while memory is being tracked")
