...
using Memoria. The agents collaborate on tasks while maintaining a shared
...
The underlying model is configured in ``memoria.json``. Edit
``agents.default_model`` to switch models.
"""
