"""
FastAPI Multi-User Memoria Application
Demonstration of how to integrate Memoria in a FastAPI application with multiple users
...
app = FastAPI(
    ...
    description="A FastAPI application demonstrating multi-user memory isolation using Memoria",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
)
...
def get_or_create_user_memory(user_id: str) -> Memoria:
    """Get existing or create new Memoria instance for user using shared database"""
...
""",
        ...
        completion(model=MODEL, messages=[session_message])
...
async def root():
    ...
    <html>
    <head>
        <title>Multi-User Memoria FastAPI</title>
        <style>
    ...
    <body>
        <h1 class="header">🧠 Multi-User Memoria FastAPI</h1>
...
if __name__ == "__main__":
    ...
    print("🚀 Starting Multi-User Memoria FastAPI Application")
    print("=" * 60)
    print("Features:")
