"""
Digital Ocean + Memoria Integration Example

A memory-enhanced AI customer support assistant using Digital Ocean's AI platform
with Memoria for persistent conversation memory and context-aware responses.
...
# Initialize Memoria for persistent memory with Digital Ocean namespace
...
def create_memory_search_function(memoria_tool):
    ...
    def search_customer_memory(query: str) -> str:
        ...
        try:
            ...
            result = memoria_tool.execute(query=query.strip())
